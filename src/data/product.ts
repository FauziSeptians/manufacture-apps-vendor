...
export const product = {
  ...
  backpack: [
    ...
    {
      title: 'Backpack-2',
      url: '/assets/product/backpack/backpack2.png',
      imageClass: '',
      description: DESCRIPTIONS.backpack,
    },
    {
    ...
    {
      title: 'Backpack-4',
      url: '/assets/product/backpack/backpack4.png',
      imageClass: '',
      description: DESCRIPTIONS.backpack,
    },
    {
      title: 'Backpack-5',
      url: '/assets/product/backpack/backpack5.png',
      imageClass: '',
      description: DESCRIPTIONS.backpack,
    },
    {
      title: 'Backpack-6',
      url: '/assets/product/backpack/backpack6.png',
      imageClass: '',
      description: DESCRIPTIONS.backpack,
    },
    {
  ...
  totebag: [
    {
      title: 'totebag-1',
      url: '/assets/product/totebag/totebag1.png',
      imageClass: '',
      description: DESCRIPTIONS.totebag,
    },
    {
      title: 'totebag-2',
      url: '/assets/product/totebag/totebag2.png',
      imageClass: '',
      description: DESCRIPTIONS.totebag,
    },
    {
      title: 'totebag-3',
      url: '/assets/product/totebag/totebag3.png',
      imageClass: '',
      description: DESCRIPTIONS.totebag,
    },
    {
  ...
  pouch: [
    {
      title: 'pouch-1',
      url: '/assets/product/pouch/pouch1.png',
      imageClass: '',
      description: DESCRIPTIONS.pouch,
    },
    {
      title: 'pouch-2',
      url: '/assets/product/pouch/pouch2.png',
      imageClass: '',
      description: DESCRIPTIONS.pouch,
    },
    {
