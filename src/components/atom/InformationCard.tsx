...
export default function InformationCard({
  ...
  return (
    <Card className="group relative overflow-hidden rounded-xl border border-white/20 bg-white/10 shadow-2xl backdrop-blur-md transition-all duration-300 hover:bg-white/20">
      <CardHeader className="flex flex-col items-center gap-4 space-y-0 p-8 pb-4">
        {/* Icon di tengah */}
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-amber-500 text-white shadow-lg transition-transform group-hover:scale-110">
          <Icon size={32} />
        </div>
